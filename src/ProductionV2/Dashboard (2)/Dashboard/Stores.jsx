...
const Stores = () => {
  ...
  const [inwardData, setInwardData] = useState([
    { id: 1, name: 'Purchase GRN', value: 0, color: '#6366f1' },
    { id: 2, name: 'Return Inward', value: 0, color: '#f59e0b' },
    { id: 3, name: 'Production', value: 0, color: '#10b981' },
  ...
  const [outwardData, setOutwardData] = useState([
    { id: 1, name: 'Sales', value: 0, color: '#6366f1' },
    { id: 2, name: 'Issue', value: 0, color: '#f59e0b' },
    { id: 3, name: 'Transfer Out', value: 0, color: '#10b981' },
